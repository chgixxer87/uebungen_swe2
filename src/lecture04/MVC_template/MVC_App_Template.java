package lecture04.MVC_template;

import javafx.application.Application;
import javafx.application.Platform;
import javafx.stage.Stage;
import lecture04.MVC_template.appClasses.App_Controller;
import lecture04.MVC_template.appClasses.App_Model;
import lecture04.MVC_template.appClasses.App_View;
import lecture04.MVC_template.splashScreen.Splash_Controller;
import lecture04.MVC_template.splashScreen.Splash_Model;
import lecture04.MVC_template.splashScreen.Splash_View;
 ...
 */
public class MVC_App_Template extends Application {
    private static MVC_App_Template mainProgram; // singleton
    ...
    @Override
    public void stop() {
        serviceLocator.getConfiguration().save(); //--> save in neuer config datei (projektordner)
        serviceLocator.getLogger().info("cfg saved");
        if (view != null) {
    ...
    protected static MVC_App_Template getMainProgram() {
        return mainProgram;
    }
}
